...
/// takes a generic `N` as the size to output.
...
/// a custom Bech32 decoding function that ignore length checks.
...
/// the MLKEM768-X25519 recipient type.
pub struct HybridRecipient {
    encapsulation_key: [u8; 1216],
}
...
impl HybridRecipient {
    /// convert this recipient to a Bech32-encoded age public key string.
    ...
    /// convert this recipient to an X25519 recipient.
    /// this is possible by essentially extracting the X25519 part of the identity from the encapsulation key.
    ...
    /// parse a Bech32-encoded age public key string to get an identity.
...
/// the MLKEM768-X25519 identity type.
...
impl HybridIdentity {
    ...
    /// convert this identity to a recipient.
    ...
    /// convert this identity to a Bech32-encoded age secret key.
    ...
    /// convert this identity to an X25519 identity.
    /// this is possible by essentially extracting the X25519 part of the identity from the seed.
